...
fdr.MDS.Id.100 = c(fdr.MDS.Id.100, fdr.mds)
power.MDS.Id.100 = c(power.MDS.Id.100, power.mds)
}


save(fdr.MDS.Id.100, power.MDS.Id.100, file = 'results/MDS_Id_100.RData')
