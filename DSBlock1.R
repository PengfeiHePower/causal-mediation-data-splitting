...
write.csv(fdr.DS,file='results/fdr/covariance/block/DSblock1.csv',row.names=F)
write.csv(power.DS, file='results/power/covariance/block/DSblock1.csv', row.names=F)
}