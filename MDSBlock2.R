...
for(reps in 1:50){
  ...
  write.csv(fdr.MDS,file='results/fdr/covariance/block/block100_2.csv',row.names=F)
  write.csv(power.MDS, file='results/power/covariance/block/block100_2.csv', row.names=F)
}
