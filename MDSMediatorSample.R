...
n.v = c(500, 1000, 2500, 5000)
p.v = c(500, 1000, 2500, 5000)
...
print(n)
print(p)
load(file = paste('data/meanModel',n,p,'.RData', sep=''))
...
write.csv(fdr.MDS,file=paste('results/fdr/size/size',n,p,'.csv',sep=''),row.names=F)
write.csv(power.MDS, file=paste('results/power/size/size',n,p,'.csv',sep=''), row.names=F)
}
}
}