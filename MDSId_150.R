...
fdr.MDS.Id.150 = c(fdr.MDS.Id.150, fdr.mds)
power.MDS.Id.150 = c(power.MDS.Id.150, power.mds)
save(fdr.MDS.Id.150, power.MDS.Id.150, file = 'results/MDS_Id_150.RData')
}
