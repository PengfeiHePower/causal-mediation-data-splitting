...
write.csv(fdr.DS,file='results/fdr/covariance/block/DSblock4.csv',row.names=F)
write.csv(power.DS, file='results/power/covariance/block/DSblock4.csv', row.names=F)
}