...
write.csv(fdr.DS,file=paste('results/fdr/signal/DSsign',delta,'.csv',sep=''),row.names=F)
write.csv(power.DS, file=paste('results/power/signal/DSsign',delta,'.csv',sep=''), row.names=F)
}
}
